...
namespace hvmbot.TelegramPart
{
    class PollingBot
    {
...

        {
            ...
            var SocksProxy = new HttpToSocks5Proxy(Configuration.Proxy.GetHost(), Configuration.Proxy.GetPort());

            Bot = new TelegramBotClient(Configuration.TGAuth.GetTGBotToken(), SocksProxy);
