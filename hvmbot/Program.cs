...
namespace hvmbot
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var VK_KATE_MOBILE_TOKEN = System.Environment.GetEnvironmentVariable("VK_KATE_MOBILE_TOKEN");

            //var DB_HOST = DotNetEnv.Env.GetString("DB_HOST");
            //var DB_PORT = DotNetEnv.Env.GetInt("DB_PORT");
            //var DB_NAME = DotNetEnv.Env.GetString("DB_NAME");
            //var DB_LOGIN = DotNetEnv.Env.GetString("DB_LOGIN");
            //var DB_PASS = DotNetEnv.Env.GetString("DB_PASS");
            ...
            //Configuration.VKAuth.SetVKKateMobileToken(VK_KATE_MOBILE_TOKEN);
            ...
            //Configuration.DBAuth.SetHost(DB_HOST);
            //Configuration.DBAuth.SetPort(DB_PORT);
            //Configuration.DBAuth.SetDatabaseName(DB_NAME);
            //Configuration.DBAuth.SetUsername(DB_LOGIN);
            //Configuration.DBAuth.SetPassword(DB_PASS);
