...
namespace hvmbot.VKPart
{
    class LongPollHandler
    {
        ...
        ////Not Needed
        private static readonly string vkapiToken = Configuration.VKAuth.GetVKApiToken(); //Обновления группы 
        private static readonly ulong groupID = Configuration.VKAuth.GetVKGroupID();
                                ...
                                if (photoList2Load.Count > 0)
                                {
                                    try
                                    {
                                        ...
                                        var photos = api.Photo.GetById(photoList2Load, null, photoSizes: true); //, photoSizes: true
                                                                                                                ...
                                                                                                                //var photos = api.Photo.GetById(photoList2Load);
